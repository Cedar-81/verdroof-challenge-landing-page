...
export default function Leaderboard() {
  ...
  return (
    <div className="h-full min-h-[100vh] w-full bg-gray-300 text-black">
      ...
      />
      <div className="w-[70%] mx-auto px-[50px] h-[20vh] mt-20 flex justify-between items-center ">
        <h1 className="text-3xl font-kenyan">
          Here are the scores earned so far
        </h1>
        <h2 className="text-xl font-kenyan">Dated: {formattedDate}</h2>
      </div>
