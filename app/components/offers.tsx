...
export default function Offers({
  ...
  return (
    <div className="grid grid-cols-3 h-[40vh]">
      <div className="h-full relative">
        ...
        <div className="relative z-10 text-black p-[32px] space-y-4 h-full w-full bg-white/70">
          <div className="space-y-2">
            <h3 className="text-4xl font-kenyan text-brand_primary">
              Find a roommate
            </h3>
            <p className="text-lg font-serenata">
          ...
          <button
            ...
            className="text-lg font-kenyan bg-brand_accent text-white px-5 py-3"
          >
            TRY IT OUT
          </button>
        </div>
      ...
      <div className="h-full text-white relative bg-brand_primary">
        <div className="relative z-10 p-[32px] space-y-4 h-full w-full">
          <div className="space-y-2">
            <h3 className="text-4xl font-kenyan">
      ...
      <div className="h-full relative">
        ...
        <div className="relative z-10 text-black p-[32px] space-y-4 h-full w-full bg-white/70">
          <div className="space-y-2">
            <h3 className="text-4xl font-kenyan text-brand_secondary">
              Become a partner
            </h3>
            <p className="text-lg font-serenata">
